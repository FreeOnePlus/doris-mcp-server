...
class DorisMCPStreamableServer:
    ...
    def _format_tool_call_result(self, result: Any) -> Dict[str, Any]:
        # ... (implementation - ensure this handles None gracefully) ...
        content_list = []
    ...
    def _process_tool_arguments(self, tool_name, arguments, recent_query):
         # ... (implementation - remove callback here if not already done) ...
        processed_args = dict(arguments)
        processed_args.pop('callback', None) # Ensure callback is removed
        # ... (rest of random_string logic) ...
