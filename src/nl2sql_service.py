...
class NL2SQLService:
    ...
    async def mcp_doris_nl2sql_query(self, query: str = None) -> Dict[str, Any]:
        """
    ...
    async def mcp_doris_nl2sql_query_stream(self, query: str) -> Dict[str, Any]:
        """
    ...
    async def mcp_doris_list_database_tables(self) -> Dict[str, Any]:
        """
        列出数据库中的所有表
    ...
    async def mcp_doris_explain_table(self, table_name: str) -> Dict[str, Any]:
        """
        获取表结构的详细信息
        ...
        try:
            ...
            # 获取表结构
            result = self.explain_table(table_name)
    ...
    async def mcp_doris_get_business_overview(self) -> Dict[str, Any]:
        """
        获取数据库业务领域概览
        ...
        try:
            # 获取业务领域概览
            result = self.get_business_overview()
    ...
    async def mcp_doris_get_nl2sql_status(self) -> Dict[str, Any]:
        """
        获取当前NL2SQL处理状态
        ...
        try:
            ...
            # 获取Doris版本
            try:
                doris_version = self.get_doris_version()
            except:
                doris_version = "未知"
            
            # 获取缓存的表数量
            cached_table_count = self.get_cached_table_count()
    ...
    async def mcp_doris_refresh_metadata(self) -> Dict[str, Any]:
        """
        刷新并保存元数据
        ...
        try:
            ...
            refresh_result = self._refresh_metadata(force=force_refresh)
    ...
    async def mcp_doris_sql_optimize(self, sql: str = None) -> Dict[str, Any]:
        """
    ...
    async def mcp_doris_fix_sql(self, sql: str = None, error_message: str = "") -> Dict[str, Any]:
        """
        修复SQL语句中的错误
